...
const Privacy: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    while (i < lines.length) {
      ...
      // Type/Administered by/Purpose lines
      if (line.startsWith('Type:') || line.startsWith('Administered by:') || line.startsWith('Purpose:')) {
        elements.push(<MetaText key={i}>{line}</MetaText>);
        i++;
        continue;
      }
