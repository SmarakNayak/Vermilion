          ...
          <InscriptionContainer>
            {inscription.is_recursive==true && inscription.content_type=='image/svg+xml'
              ...
              : {
                  ...
                  'text/html;charset=utf-8': <HtmlContainer><StyledIframe src={"/content/"+ inscription.id} scrolling='no' sandbox='allow-scripts allow-same-origin'></StyledIframe></HtmlContainer>,
                  'text/html': <HtmlContainer><StyledIframe src={"/content/"+ inscription.id} scrolling='no' sandbox='allow-scripts allow-same-origin'></StyledIframe></HtmlContainer>,
