...
const Inscription = () => {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      ...
      setModelUrl(null); // Reset modelUrl
            ...
            {
              {
                ...
                'html': <HtmlContainer><StyledIframe src={`/content/${metadata?.id}?ssr=true`} scrolling='no' sandbox='allow-scripts allow-same-origin' loading="lazy"></StyledIframe></HtmlContainer>,
                ...
                <SectionPadding gap={'.75rem'}>
                    ...
                    <CollectionWrapper>
                      <CollectionLink to={'/collection/' + metadata?.collection_symbol}>
                        <CollectionContainer>
                          ...
                          <IconWrapper>
                            <RibbonIcon size={'1.25rem'} color={'#E34234'} />
                          </IconWrapper>
                        </CollectionContainer>
                      </CollectionLink>
                    </CollectionWrapper>
                    ...
                    <RuneWrapper>
                      <RuneContainer isRune={true}>
                        <IconWrapper isRune={true}>
                          <RuneIcon size={'1.25rem'} color={'#D23B75'} />
                        </IconWrapper>
                        <CollectionText>
                  ...
                  {(metadata?.delegate || metadata?.is_recursive || metadata?.parents.length > 0 || childrenInscriptions.length > 0) && (
                    <Stack horizontal={true} gap={'.5rem'} style={{flexWrap: 'wrap'}}>
                      {metadata?.delegate && (
                        <TagContainer>
                          <LayersIcon size={'1.125rem'} color={'#000000'} />
                          Delegate
                        </TagContainer>
                      )}
                      {metadata?.is_recursive && (
                        <TagContainer>
                          <RepeatIcon size={'1.125rem'} color={'#000000'} />
                          Recursive
                        </TagContainer>
                      )}
                      {childrenInscriptions.length > 0 && (
                        <TagContainer>
                          <Person2Icon size={'1.125rem'} color={'#000000'} />
                          Parent
                        </TagContainer>
                      )}
                      {metadata?.parents.length > 0 && (
                        <TagContainer>
                          <SproutIcon size={'1.125rem'} color={'#000000'} />
                          Child
                        </TagContainer>
                      )}
                    </Stack>
                ...
                {/* <PillContainer>
                  {editionNumber != null && editionNumber != undefined && (
                    <UnstyledLink to={'/edition/' + metadata?.sha256}>
                      <DataButton>
                        <HashIcon size={'1rem'} color={'#959595'}></HashIcon>
                  ...
                  <UnstyledLink to={'https://ordinals.com/inscription/' + metadata?.id} target='_blank'>
                    <DataButton>
                      <WebIcon size={'1rem'} color={'#959595'}></WebIcon>
              ...
              <DataContainer gapsize={'.75rem'}>
                <SectionHeader onClick={() => toggleSectionVisibility('details')}>
                  ...
                  {sectionVisibility.details ? (
                    <ChevronUpSmallIcon size={'1.25rem'} color={'#000000'} />
                  ) : (
                    <ChevronDownSmallIcon size={'1.25rem'} color={'#000000'} />
                  )}
                </SectionHeader>
                      ...
                      <InfoRowContainer isMiddle={true}>
                        ...
                        <InfoDataContainer>
                          <UnstyledButton onClick={() => copyText(metadata?.id)}>
                            ...
                            <CopyIcon size={'1rem'} color={'#D9D9D9'} />
                          </UnstyledButton>
                        </InfoDataContainer>
                      </InfoRowContainer>
                      <InfoRowContainer isMiddle={true}>
        ...
        <SimilarContentContainer>
          <SectionContainer>
            <SectionHeaderContainer>
              <SparklesIcon size={'1.5rem'} color={'#000000'} />
              <SimilarText>Similar Inscriptions</SimilarText>
            </SectionHeaderContainer>
            {/* <ArrowContainer>
              <ArrowButton onClick={scrollLeft}>
                <ChevronLeftIcon size={'1.25rem'} color={'#959595'} />
              </ArrowButton>
              <ArrowButton onClick={scrollRight}>
                <ChevronRightIcon size={'1.25rem'} color={'#959595'} />
              </ArrowButton>
            </ArrowContainer> */}
          </SectionContainer>
