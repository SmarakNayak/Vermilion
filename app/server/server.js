  ...
  routes: {
    ...
    '/social/create_profile/:address': async req => {
      ...
      try {
        ...
        let body = await req.json();
        let profile = body;
        profile.user_addresses = [req.params.address];
        ...
        //   user_addresses: [req.params.address],
        ...
        let [insertRecord] = await db.createProfile(profile);
    ...
    '/social/update_profile/:user_id': async req => {
      if (req.method !== 'POST') {
        return new Response('Method Not Allowed', { status: 405 });
      }
      try {
        ...
        //   user_handle: body.user_handle,
        //   user_name: body.user_name,
        //   user_addresses: body.user_addresses,
        //   user_picture: body.user_picture, //inscription ID
        //   user_bio: body.user_bio,
        //   user_twitter: body.user_twitter,
        //   user_discord: body.user_discord,
        ...
        // });
        // add some validation here
        let [updateRecord] = await db.updateProfile(body);
